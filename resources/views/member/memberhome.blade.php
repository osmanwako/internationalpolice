                ...
                @if (Auth::guard('member'))
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title" style="text-alignment:right;">Registration Form of EAPCCO Member.</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                @endif
                                <form method="POST" action="{{ route('memberregister') }}" enctype="multipart/form-data">
                                    @csrf
                                    {{-- //start form here --------------------------------------------------------------------------------- --}}
                                    <div class="col-md-11 mb-3">
                                        <div class="form-group">
                                            <label for="idnoid" class="form-label">Passport Number</label>
                                            <input type="text" id="idnoid" placeholder="Enter Passport Number"
                                                class="form-control @error('idno') is-invalid @enderror" name="idno"
                                                value="{{ old('idno') }}" autofocus>
                                            @error('idno')
                                    ...
                                    <div class="col-md-11 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="lastnameid" placeholder="Enter last name here"
                                    ...
                                    <div class="col-md-11 mb-3">
                                        <div class="form-group">
                                            <label for="secondnameid" class="form-label">Second Name</label>
                                            <input type="text" id="secondnameid" placeholder="Enter second name here"
                                    ...
                                    <div class="col-md-11 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="profileid"
                                                ...
                                                value="{{ old('profile') }}" autofocus style="display: none"
                                                onchange="changeimage(event)" accept="image/*">
                                            <label for="profileid" class="form-control"
                                                style="white-space: nowrap;overflow: hidden; text-overflow: ellipsis"><i
                                                    class="bi bi-image"></i>
                                                <span style="color: green;" id="spanfilenameid">Select Your
                                                    Photo</span></label>
                                            @error('profile')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            @enderror
                                            <div class="alert alert-success text-center" role="alert" id="profilediv"
                                                style="display: none;">
                                                <img src="{{ url('asset/images/nophoto.png') }}" class="rounded-circle"
                                                    alt="Member Profile" style="width:160px;height:160px;"
                                                    id="profile_img">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-11 mb-3">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="form-control btn"
                                                style="background-color: #0b2c4b; text-align: center; color:#ecd08a;">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
